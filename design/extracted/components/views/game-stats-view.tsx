        ...
        <>
          ...
          <Tabs defaultValue="scoring" className="mt-6">
            ...
            <TabsContent value="passing" className="mt-4 space-y-2">
              {playerStatsForGame.filter(p => p.stats.completions > 0 || p.stats.turnovers > 0).length === 0 ? (
                <p className="text-center text-muted-foreground py-4">No passing stats recorded</p>
              ) : (
                playerStatsForGame
                  .filter(p => p.stats.completions > 0 || p.stats.turnovers > 0)
                      ...
                      <Card key={player.id}>
                        <CardContent className="py-3">
                          ...
                          <div className="flex items-center gap-4 text-sm text-muted-foreground">
                            <span>
                              <span className="text-green-500 font-medium">{stats.completions}</span> comp
                            </span>
                            <span>
